...
/// <summary>Fixed LiteNetLib channel ids for Rex networking.</summary>
public static class DeliveryChannel
{
    /// <summary>Reliable ordered lane for handshake and other ordered traffic.</summary>
    ...
    /// <summary>Sequenced lane for snapshots.</summary>
    ...
    /// <summary>Reliable unordered lane for commands and similar traffic.</summary>
    ...
    /// <summary>Best effort lane for input.</summary>
    ...
    /// <summary>Separate lane so bulk transfers do not stall game state traffic.</summary>
