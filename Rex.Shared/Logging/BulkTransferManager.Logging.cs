...
public sealed partial class BulkTransferManager
{
    ...
    private partial void LogStartedBulkTransfer(Guid transferId, byte dataType, int originalSize, bool isCompressed,
    ...
    private partial void LogReceivingBulkTransfer(Guid transferId, byte dataType, int chunkCount, int totalSize);
    ...
    private partial void LogBulkTransferComplete(Guid transferId, byte dataType, int size);
}
